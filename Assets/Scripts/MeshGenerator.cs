    ...
    void CreateWallMesh()
    {
        ...
        foreach (List<int> outline in m_wallOutlines)
        {
            for (int i = 0; i < outline.Count - 1; i++)
            {
                ...
                wallVertices.Add(m_vertices[outline[i]] - Vector3.up * wallHeight); //Bottom Left Corner
                wallVertices.Add(m_vertices[outline[i + 1]] - Vector3.up * wallHeight); //Bottom Right Corner
